  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      >
        ...
        >
          Protecting your personal information with transparency and care.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="space-y-4 mb-8">
            {[
              "Data Collection: We collect only necessary information, such as name, email, and payment details, to provide our services.",
              "Data Usage: Your information is used solely to deliver services, process payments, and improve user experience.",
              "Data Protection: We use industry-standard encryption and security measures to protect your data from unauthorized access.",
              "Third-Party Sharing: We do not sell or share your personal information with third parties, except as required by law or for service delivery.",
              "Cookies: Our website uses cookies to enhance user experience and analyze site performance, with your consent.",
              "Data Retention: We retain your data only for as long as necessary to fulfill the purposes outlined in this policy.",
