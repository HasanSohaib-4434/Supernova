  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      >
        ...
        >
          Our terms for using our services and website.
        </p>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="space-y-4 mb-8">
            {[
              "Acceptance: By using our services, you agree to be bound by these terms and conditions.",
              "Service Usage: Our services are provided as-is, and we reserve the right to modify or discontinue them at any time.",
              "Payment Terms: All payments must be made in accordance with our pricing and billing policies.",
              "User Responsibilities: You agree to provide accurate information and comply with all applicable laws.",
              "Termination: We may terminate your access to our services for violation of these terms.",
              "Liability: We are not liable for any damages arising from the use of our services, except as required by law.",
              "Intellectual Property: All content and materials provided by us are protected by intellectual property laws."
            ].map((item, index) => (
              <div
                key={index}
