...
const services = [
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      >
        <div
          className={`text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent animate-hero-title ${
        ...
        <div
          className={`text-2xl md:text-4xl mb-4 text-gray-200 animate-bounce-in stagger-1 ${
            isVisible("section-0") ? "visible" : ""
          }`}
        >
          We provide{" "}
        ...
        <button
          className={`mt-6 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold py-6 px-12 rounded-full transition-all duration-500 hover:scale-110 animate-glow animate-bounce-in stagger-4 ${
            isVisible("section-0") ? "visible" : ""
          }`}
          style={{
      ...
      <div ref={digitalExcellenceRef} className="relative z-10 py-20 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            <h3
              className={`text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent animate-slide-left ${
            ...
            <p
              className={`text-lg md:text-xl text-gray-300 leading-relaxed mb-8 animate-slide-left stagger-1 ${
                isVisible("section-1") ? "visible" : ""
              }`}
            >
              At Supernova Solutions, we're dedicated to elevating your online
              presence with cutting-edge solutions. Transform your digital
              landscape with our innovative strategies that drive exponential
              growth and unlock unprecedented potential for your business in the
              digital age.
            </p>
            <div className="space-y-4">
              <div
                className={`flex items-center space-x-3 animate-slide-left stagger-2 ${
                  isVisible("section-1") ? "visible" : ""
                }`}
              >
              ...
              <div
                className={`flex items-center space-x-3 animate-slide-left stagger-3 ${
                  isVisible("section-1") ? "visible" : ""
                }`}
              >
                <div
              ...
              <div
                className={`flex items-center space-x-3 animate-slide-left stagger-4 ${
                  isVisible("section-1") ? "visible" : ""
                }`}
              >
                <div
                  className="w-4 h-4 bg-purple-700 rounded-full animate-pulse"
          ...
          >
            <div className="relative w-52 sm:w-64 md:w-96 aspect-square mx-auto">
          ...
          {[
            {
              ...
              desc: "Dominate search results with our advanced SEO strategies and optimization techniques.",
              icon: "🚀",
              path: "/services/seo-optimization",
            },
            {
              title: "Website Design & Development",
              desc: "Build modern, responsive, and SEO-friendly websites tailored to your business goals.",
              icon: "💻",
              path: "/services/website-development",
            },
            {
              title: "Google My Business",
              desc: "Maximize local visibility and attract high-quality customers with optimized GMB profiles.",
              icon: "📍",
            ...
            >
              <div className="service-icon text-6xl mb-6 transform transition-all duration-300">
                {service.icon}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[
            { 
              ...
              popular: false,
              features: [
                { name: "GBP Optimization Or Website Optimization", included: true },
                { name: "Citations", included: true },
                { name: "Banners, Flyers, Business Cards", included: true },
                { name: "Customer Support", included: true },
                { name: "Youtube", included: false },
                { name: "Meta", included: false },
                { name: "Managing All Social Media Profile", included: false }
              ]
            },
            { 
              name: "Professional", 
            ...
            { 
              ...
              features: [
                ...
                { name: "Youtube", included: true },
                { name: "Meta", included: true },
                { name: "Managing All Social Media Profile", included: true }
              ]
            },
          ].map((plan, index) => (
            <div
              key={index}
              id={`plan-${index}`}
              className={`pricing-card relative bg-gradient-to-br from-gray-900/60 to-blue-900/60 backdrop-blur-md rounded-3xl p-8 text-white border transition-all duration-500 ${
                plan.popular
                  ? "border-blue-500 scale-105 shadow-2xl"
                  : "border-blue-600/40"
              } card-hover animate-fade-scale stagger-${index + 1} ${
                isVisible("section-3") ? "visible" : ""
              }`}
            >
              {plan.popular && (
              ...
              <h4 className="text-2xl font-bold mb-4 text-center text-gray-300">
                {plan.name}
              </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {[
            ...
            <div
              key={index}
              id={`team-${index}`}
              className={`team-card bg-gradient-to-br from-gray-900/60 to-blue-900/60 backdrop-blur-md rounded-3xl p-8 text-white text-center border border-blue-600/40 card-hover animate-fade-scale stagger-${
                index + 1
              } ${isVisible("section-4") ? "visible" : ""}`}
            >
              <div className="team-avatar text-8xl mb-6 transform transition-all duration-300">
                {member.avatar}
              </div>
              <h4 className="text-xl font-bold mb-2 text-gray-300">
                {member.name}
              </h4>
 ...
 <div ref={reviewsRef} className="relative z-10 py-20 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {[
            {
              review:
                "Absolutely revolutionary! Supernova Solutions transformed our digital presence beyond our wildest expectations. The strategies delivered phenomenal results!",
              author: "Sarah Johnson",
              rating: 4,
            },
            {
              review:
                "Outstanding service and incredible results. The team's expertise in digital marketing is unmatched. Highly recommend for serious business growth!",
              author: "Michael Chen",
              rating: 5,
            },
            ...
            <div
              key={index}
              id={`review-${index}`}
              className={`bg-gradient-to-br from-gray-900/60 to-blue-900/60 backdrop-blur-md rounded-3xl p-8 text-white border border-blue-600/40 card-hover transition-all duration-500 ${
