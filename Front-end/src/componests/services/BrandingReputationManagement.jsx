...
const BrandingReputationManagement = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      >
        ...
        >
          Build and maintain a positive digital brand identity.
        </p>
      </div>
      ...
      >
        ...
        <div
          className={`bg-gradient-to-br from-gray-900/60 to-blue-900/60 backdrop-blur-md rounded-3xl p-6 sm:p-8 text-white border border-blue-600/40 card-hover animate-on-scroll stagger-1 ${
            isVisible('section-1') ? 'visible' : ''
          }`}
        ...
        >
          ...
          >
            Our Branding & Online Reputation Management service helps you create a strong brand identity and maintain a positive online presence through strategic monitoring and engagement.
          </p>
          <div className="space-y-4 mb-8">
            {[
              "Brand Identity Development: Build a strong, consistent, and memorable digital presence.",
"Online Review Management: Respond to reviews to maintain a positive brand image.",
"Reputation Monitoring: Track brand mentions and online sentiment regularly.",
"Crisis Management: Address negative feedback promptly and professionally.",
"Feedback Analysis: Use customer input to refine branding and improve reputation."
...
export default BrandingReputationManagement;