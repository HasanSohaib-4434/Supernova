    ...
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center text-white min-h-screen px-4 pt-20">
        ...
        <p className="text-lg md:text-xl mb-12 max-w-4xl leading-relaxed text-gray-300">
          Maximize local visibility and attract high-quality customers with optimized GMB profiles and management.
        </p>
      </div>
      ...
      <div className="relative z-10 py-20 px-4 max-w-6xl mx-auto">
        <div className="bg-gradient-to-br from-gray-900/50 to-blue-900/50 backdrop-blur-md rounded-2xl p-8 text-white border border-blue-600/30">
          ...
          <p className="text-gray-300 mb-8 leading-relaxed">
            Our Google My Business service optimizes your profile to enhance local SEO and drive customer engagement.
          </p>
          <div className="space-y-4 mb-8">
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full animate-pulse"></div>
              <span className="text-gray-300">Profile Optimization: Enhance your GMB listing.</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></div>
              <span className="text-gray-300">Review Management: Encourage and respond to reviews.</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></div>
              <span className="text-gray-300">Local SEO: Boost local search rankings.</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full animate-pulse" style={{ animationDelay: '0.6s' }}></div>
              <span className="text-gray-300">Post Scheduling: Share regular updates.</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-600 rounded-full animate-pulse" style={{ animationDelay: '0.8s' }}></div>
              <span className="text-gray-300">Analytics Tracking: Monitor performance metrics.</span>
            </div>
          </div>
          <button 
      ...
      <footer className="relative z-10 bg-gradient-to-r from-purple-900/30 to-blue-900/30 backdrop-blur-md text-center text-white py-12 border-t border-blue-600/30">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="border-t border-blue-600/30 pt-6">
            <p className="text-gray-300">© 2025 All Rights Reserved by Novatec Sol</p>
          </div>
        </div>
      </footer>
    </div>
