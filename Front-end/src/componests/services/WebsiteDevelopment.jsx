      ...
      <div ref={offerRef} className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="space-y-4 mb-8">
            {[
          "Modern Design: Build visually appealing websites aligned with business goals.",
"Responsive Design: Ensure seamless user experience across all devices.",
"SEO-Friendly Development: Structure websites to support search engine visibility.",
"Custom Functionality: Develop tailored features to meet specific business needs.",
"Performance & Security: Optimize speed and protect user data effectively."
