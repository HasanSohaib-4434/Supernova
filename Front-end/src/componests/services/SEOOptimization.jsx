    ...
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      <div ref={offerRef} className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Our SEO Optimization service leverages cutting-edge tools to boost your website's visibility and drive organic traffic.
          </p>
          <div className="space-y-4 mb-8">
            {[
             "Keyword Research & Strategy: Discover and target high-impact keywords to improve visibility.",
"On-Page Optimization: Optimize content, meta tags, and HTML elements for better relevance.",
"Technical SEO: Conduct audits to fix performance, crawling, and indexing issues.",
"Content Strategy: Plan and create SEO-friendly content to boost engagement and rankings.",
"Off-Page SEO & Link Building: Build high-quality backlinks and improve domain authority.",
"Local SEO: Optimize for local searches to increase visibility in regional results."
