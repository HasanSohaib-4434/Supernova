  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      <div ref={heroRef} className="relative z-10 flex flex-col items-center justify-center text-center text-white min-h-screen px-4 sm:px-6 lg:px-8 pt-20">
        ...
        >
          Attract and convert audiences with high-quality, engaging content.
        </p>
      </div>
      ...
      <div ref={offerRef} className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Our Content Marketing service delivers high-quality content to attract, inform, and convert your audience, driving engagement and brand loyalty.
          </p>
          <div className="space-y-4 mb-8">
            {[
          "Blog Posts: Write high-quality, informative content to attract and educate audiences.",
"Articles: Develop in-depth pieces to establish authority and showcase expertise.",
"Infographics: Create visually engaging graphics to simplify complex information.",
"Videos: Produce impactful video content tailored for different platforms.",
"Press Releases: Write professional PR content to enhance brand visibility and credibility."
