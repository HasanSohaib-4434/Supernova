    ...
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
      ...
      <div ref={offerRef} className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Our Email Marketing service provides targeted campaigns, automation, and analytics to nurture leads and drive conversions effectively.
          </p>
          <div className="space-y-4 mb-8">
            {[
            "Campaign Setup: Plan, design, and launch email campaigns to nurture leads.",
"List Management: Segment and manage subscriber lists for targeted communication.",
"Automation: Implement automated workflows to improve efficiency and consistency.",
"Analytics: Monitor key metrics to evaluate and optimize campaign performance.",
"Personalized Emails: Craft tailored messages to boost engagement and conversions."
