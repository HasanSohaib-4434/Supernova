      ...
      <div ref={offerRef} className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="space-y-4 mb-8">
            {[
              "Strategic Planning: Develop and execute platform-specific social media strategies.",
"Content Creation: Design engaging content tailored for platforms like Facebook, Instagram, LinkedIn, and Twitter.",
"Community Engagement: Interact with followers to build brand loyalty and trust.",
"Paid Campaigns: Launch and manage targeted ads to maximize reach and conversions.",
"Performance Analytics: Monitor and report campaign effectiveness with actionable insights."
