...
const Services = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-gray-950 via-purple-950 to-blue-950 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[
            { 
              ...
              icon: "🚀",
              features: ["Keyword Research & Analysis", "On-Page Optimization", "Technical SEO Audits", "Content Strategy", "Link Building"]
            },
            { 
            ...
            { 
              ...
              icon: "📱",
              features: ["Content Creation", "Community Management", "Paid Advertising", "Influencer Partnerships", "Analytics & Reporting"]
            },
            { 
              title: "Website Development", 
              desc: "Create responsive, high-performance websites that convert visitors into customers.", 
              icon: "💻",
              features: ["Responsive Design", "E-commerce Solutions", "CMS Development", "Performance Optimization", "Security Implementation"]
            },
            { 
              title: "AI Marketing Automation", 
              desc: "Leverage cutting-edge AI technology to automate and optimize your marketing campaigns.", 
              icon: "🤖",
              features: ["Email Automation", "Lead Scoring", "Predictive Analytics", "Chatbot Development", "Customer Journey Mapping"]
            }
          ].map((service, index) => (
            <div
              key={index}
              id={`service-${index}`}
              className={`bg-gradient-to-br from-gray-900/50 to-blue-900/50 backdrop-blur-md rounded-2xl p-8 text-white border border-blue-600/30 card-hover animate-on-scroll stagger-${index + 1} ${isVisible('section-1') ? 'visible' : ''}`}
            >
              ...
              <div className="space-y-3 mb-8">
                {service.features.map((feature, featureIndex) => (
                  <div key={featureIndex} className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full animate-pulse" style={{ animationDelay: `${featureIndex * 0.2}s` }}></div>
                    <span className="text-sm text-gray-300">{feature}</span>
                  </div>
                ))}
              </div>
              
              <button className="w-full bg-gradient-to-r from-purple-700 to-blue-700 hover:from-purple-800 hover:to-blue-800 text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 hover:scale-105 animate-glow">
                Get Started
              </button>
            </div>
          ))}
      ...
      {/* Process Section */}
      <div ref={processRef} className="relative z-10 py-20 px-4 bg-gradient-to-r from-purple-900/20 to-blue-900/20">
        <h2 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                id={`process-${index}`}
                className={`text-center text-white animate-on-scroll stagger-${index + 1} ${isVisible('section-2') ? 'visible' : ''}`}
              >
